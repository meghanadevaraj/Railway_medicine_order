...
<html>
    ...
    <body style="background-image: url('images/cod.jpg'); background-size: cover; background-repeat: no-repeat; background-position: center;">
        <form action="paymentserver.php" method="post">
        <p style="color:black;">Note:In Case of Order cancel After Dispatch you will be charged 20% of the order cost!</p>
